...
export const modelCandidates: ModelCandidate[] = [
  ...
  },
  {
    ...
    hardwareNotes: [
      'Source is pinned to commit 107cefdc244c39106fa830359024f6a2f1c78871.',
      'Model revision 5b521936b01fbe1890f6f9baed0254ab6351c04a is pinned and its checkpoint SHA-256 is verified.',
      'Upstream documents about 6 GB VRAM for the default single-image path.',
      'Still2Solid uses conservative extraction chunks and a CPU marching-cubes shim to avoid the upstream torchmcubes build on Apple Silicon.',
    ],
  ...
  },
  {
    manifest: {
      ...
      name: 'Stable Fast 3D',
      family: 'SF3D',
      version: 'source ff21fc49 · gated checkpoint',
    ...
    sourceLabel: 'Stability-AI/stable-fast-3d + stabilityai/stable-fast-3d',
    availability: 'gated',
    hardwareNotes: [
      'Source is pinned to commit ff21fc491b4dc5314bf6734c7c0dabd86b5f5bb2.',
      'The gated model checkpoint is checksum-verified before activation.',
    ...
    licenseNote: 'Gated access. Commercial use is subject to the Stability AI Community License, including its current revenue and registration terms. Still2Solid requires explicit acceptance and does not store the Hugging Face token.',
    runtimeAdapter: 'sf3d',
  },
  {
    manifest: {
